...
use MMWS\Model\DcDietFoodRegistry;

class DcDietFoodRegistryController
{
    
    public $model;

    public function __construct(DcDietFoodRegistry $model)
    {
        $this->model = new DcDietFoodRegistry($model);
    }
