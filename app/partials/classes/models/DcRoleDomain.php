...
use MMWS\Entity\DcRoleDomainEntity;
...
class DcRoleDomain
{
     ...
     */   
    public $table = 'dc_role_domain';


    /**
     * @var MMWS\Entity\DcRoleDomainEntity $entity the entity for this model
     */
    public $entity;
    ...
    public function __construct($id = null, $name = null, $level = null, $status = null)
    {
        $this->id = $id;
	    $this->name = $name;
	    $this->level = $level;
        ...
        $this->entity = new DcRoleDomainEntity($this);
    }
