...
use MMWS\Entity\DcSessionsEntity;
...
class DcSessions
{
     ...
     */   
    public $table = 'dc_sessions';


    /**
     * @var MMWS\Entity\DcSessionsEntity $entity the entity for this model
     */
    public $entity;
    ...
    public function __construct($id = null, $userid = null, $sessionToken = null, $lastLogin = null, $status = null, $userCurIp = null)
    {
        $this->id = $id;
	    $this->userid = $userid;
	    ...
	    $this->status = $status;
	    $this->userCurIp = $userCurIp;
	    
        $this->entity = new DcSessionsEntity($this);
    }
