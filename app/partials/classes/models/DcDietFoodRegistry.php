...
use MMWS\Entity\DcDietFoodRegistryEntity;

class DcDietFoodRegistry
{

    /**
     * @var String $table the table name for this model;
     */   
    public $table = 'dc_diet_food_registry';


    /**
     * @var MMWS\Entity\DcDietFoodRegistryEntity $entity the entity for this model
     */
    public $entity;
    ...
    public function __construct($id = null, $foodId = null, $dietId = null, $status = null, $createdAt = null)
    {
        $this->id = $id;
	    $this->foodId = $foodId;
	    $this->dietId = $dietId;
        ...
        $this->entity = new DcDietFoodRegistryEntity($this);
    }
