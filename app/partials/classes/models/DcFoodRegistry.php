...
use MMWS\Entity\DcFoodRegistryEntity;

class DcFoodRegistry
{

    /**
     * @var String $table the table name for this model;
     */   
    public $table = 'dc_food_registry';


    /**
     * @var MMWS\Entity\DcFoodRegistryEntity $entity the entity for this model
     */
    public $entity;
    ...
    public function __construct($id = null, $foodName = null, $foodCalories = null, $foodCarbohidrates = null, $foodFat = null, $foodSodium = null, $createdAt = null, $status = null, $foodUcode = null, $foodProtein = null)
    {
        $this->id = $id;
	    $this->foodName = $foodName;
	    $this->foodCalories = $foodCalories;
	    $this->foodCarbohidrates = $foodCarbohidrates;
	    $this->foodFat = $foodFat;
	    $this->foodSodium = $foodSodium;
	    $this->createdAt = $createdAt;
	    $this->status = $status;
	    $this->foodUcode = $foodUcode;
	    $this->foodProtein = $foodProtein;
	    
        $this->entity = new DcFoodRegistryEntity($this);
    }
